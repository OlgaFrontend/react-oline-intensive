...
10. Перейди в браузер и открой страничку [http://localhost:3002](http://localhost:3002/). Когда страничка загрузится, ты увидишь страницу с сообщением «Привет! Начало здесь.».
